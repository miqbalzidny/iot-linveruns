                    ...
                    <li class="relative px-6 py-3">
                        ...
                        <template x-if="isPagesMenuOpen">
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <li
                                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                    <a class="w-full" href="{{ url('/pf') }}">Power Factor</a>
                                </li>
                            </ul>
                        </template>
                    </li>
        ...
        <div class="flex flex-col flex-1">
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <img src="assets/admin-dashboard/img/profile-creator.jpg" alt="Image Creator"
                        class="rounded mx-auto d-block mb-3" width="200px">
                </div>

                <div class="w-full mt-4 mb-8 overflow-hidden rounded-lg shadow-xs">
                    <div class="w-full overflow-x-auto mx-auto">
                        <table class="w-full whitespace-no-wrap ml-6 mr-6">
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        Karangglonggong RT 2 RW 2, Klirong, Kebumen, Central Java, Indonesia
                                    </td>
                                </tr>
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td class="px-4 py-3">
