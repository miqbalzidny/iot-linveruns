            ...
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul>
                    ...
                    <li class="relative px-6 py-3">
                        ...
                        <template x-if="isPagesMenuOpen">
                            <ul x-transition:enter="-tabletransition-all ease-in-out duration-300"
                                x-transition:enter-start="opacity-25 max-h-0"
                                x-transition:enter-end="opacity-100 max-h-xl"
                                x-transition:leave="transition-all ease-in-out duration-300"
                                x-transition:leave-start="opacity-100 max-h-xl"
                            ...
                            <table class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3">Power Value</th>
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    @if ($power->count())
                                        @foreach ($power as $key => $nilaidaya)
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                <td class="px-4 py-3 text-sm">{{ $power->firstItem() + $key }}
                                                </td>
                                                <td class="px-4 py-3 text-sm">
                                                    {{ number_format($nilaidaya->power_value, 2) }}
                                                </td>
                                                <td class="px-4 py-3 text-sm">{{ $nilaidaya->created_at }}</td>
                                                <td class="px-4 py-3 text-sm">{{ $nilaidaya->updated_at }}</td>
                                            </tr>
                                        @endforeach
                                    @endif
                                </tbody>
