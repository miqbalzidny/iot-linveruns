                            ...
                            <table class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3">Power Factor Value</th>
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    @if ($pf->count())
                                        @foreach ($pf as $key => $nilaidaya)
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                <td class="px-4 py-3 text-sm">{{ $pf->firstItem() + $key }}
                                                </td>
                                                <td class="px-4 py-3 text-sm">
                                                    {{ number_format($nilaidaya->powerfactor_value, 2) }}
                                                </td>
