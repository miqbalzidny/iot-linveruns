                        ...
                        <div class="w-full overflow-x-auto">
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    @if ($current->count())
                                        @foreach ($current as $key => $nilaiarus)
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                <td class="px-4 py-3 text-sm">{{ $current->firstItem() + $key }}</td>
                                                <td class="px-4 py-3 text-sm">
                                                    {{ number_format($nilaiarus->current_value, 2) }}</td>
                                                <td class="px-4 py-3 text-sm">{{ $nilaiarus->created_at }}</td>
                                                <td class="px-4 py-3 text-sm">{{ $nilaiarus->updated_at }}</td>
                                            </tr>
                                        @endforeach
                                    @endif
                                </tbody>
