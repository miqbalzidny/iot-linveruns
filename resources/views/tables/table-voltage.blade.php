                            ...
                            <table class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3">Voltage Value</th>
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    @if ($voltage->count())
                                        @foreach ($voltage as $key => $nilaitegangan)
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                <td class="px-4 py-3 text-sm">{{ $voltage->firstItem() + $key }}</td>
                                                <td class="px-4 py-3 text-sm">
                                                    {{ number_format($nilaitegangan->voltage_value, 2) }}</td>
                                                <td class="px-4 py-3 text-sm">{{ $nilaitegangan->created_at }}</td>
                                                <td class="px-4 py-3 text-sm">{{ $nilaitegangan->updated_at }}</td>
                                            </tr>
                                        @endforeach
                                    @endif
                                </tbody>
