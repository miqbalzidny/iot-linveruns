                            ...
                            <table class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3">Energy Value</th>
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    @if ($energy->count())
                                        @foreach ($energy as $key => $nilaienergi)
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                <td class="px-4 py-3 text-sm">{{ $energy->firstItem() + $key }}</td>
                                                <td class="px-4 py-3 text-sm">
                                                    {{ number_format($nilaienergi->energy_value, 2) }}</td>
                                                <td class="px-4 py-3 text-sm">{{ $nilaienergi->created_at }}</td>
                                                <td class="px-4 py-3 text-sm">{{ $nilaienergi->updated_at }}</td>
                                            </tr>
                                        @endforeach
                                    @endif
                                </tbody>
